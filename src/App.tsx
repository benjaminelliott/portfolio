  ...
  certifications: [
    {
      key: 0,
      name: "Ironhack",
      image: "logos/Ironhack_id7-lIFEiH_0.jpeg",
      logo: "logos/Ironhack_idVsNwhECC_4.svg",
      description:
        "Doing a full stack web development bootcamp with Ironhack, due to graduate in August 2024.",
    ...
    },
    {
      ...
      description:
        "Completed the Meta Front-End Developer professional certification on Coursera, confirming my capabilities as a front-end developer",
    ...
    },
    {
      ...
      description:
        "Completed Responsive Web Design certification, specializing in creating responsive pages with HTML, CSS and Javascipt",
    ...
    },
    {
      ...
      logo: "logos/freecodecamp.svg",
      description:
        "Completed Javascript algorithms and data sctuctures, specializing in using different data types and structures in Javascript ES6",
  ...
  projects: [
    {
      ...
      description:
        "Stacy is the Markets Editor at Decrypt, a cryptocurrency, AI, culture and gaming news site. She wanted a simple portfolio page that reflected her personality. I built her a striking page with Wordpress.",
    ...
    },
    {
      ...
      description:
        "A single page app which fetches state and county data from the 2019 US Census, before asking ChatGPT for advice on stuff to do in the user's location.",
      techStack: [
        "HTML5",
        "CSS3",
        "Javascript",
    ...
    },
    {
      ...
      description:
        "My portfolio page, completed after all my online courses. Built to industry best practices using Typescript and React. Always adding new projects as they're built.",
      techStack: ["HTML5", "CSS3", "Javascript", "Typescript", "React", "SASS"],
