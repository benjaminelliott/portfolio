        ...
        <animated.div id="home" className="home" style={{...springs}}>
            <article className="content-home">
                <div className="home-upper">
                    ...
                    <img className="home-hero" src={Benjamin.image} alt="whoops" />
                </div>
                <div className="home-lower">
                    <div className="home-intro">
                        <h2 className="intro-first">{Benjamin.intro1}</h2>
                        <h3 className="intro-second">{Benjamin.intro2}</h3>
                    ...
                    <Link className="home-call-link" to="contact"><button className="home-call">{Benjamin.call}</button></Link>
                </div>
            </article>
        </animated.div>
    );
